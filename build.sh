...
bspatch /usr/libexec/trustd trustdintel patch.bspatch 		 # patch for strings in intel half made by bsdiff
bspatch /usr/libexec/trustd trustdarm ARMFINALPATCH.bspatch    # patch for strings in the arm half

printf "\033[1;35m[checking]\033[1;33m hehe owo \033[0m\n"
echo `lipo trustdintel -archs`                                   # lets check these
echo `lipo trustdarm -archs`                                     #
xxd -e trustdintel | grep 00000000:				 #
xxd -e trustdarm | grep 00000000:				 #
